...
## Project Structure
    ...
    ├── testapiautostoryboa_56267  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_56267`
...
2. Clone this repo and `cd testapiautostoryboa_56267`
